class CvBuilderController < ApplicationController
  ...
  def permitted_params
    params.require(:resume).permit(:section_names,
      achievements_attributes: [:title, :description, :id, :show_description, :show_title, :item_index],
      awards_attributes: [:name, :id, :show_description, :show_icon, :item_index],
      ...
      educations_attributes: [:degree_name, :university_name, :id, :duration, :cgpa, :show_location, :show_period, :show_outcomes, :show_gpa, :item_index],
      experiences_attributes: [:id, :title, :company_name, :location, :duration, :description, :show_location, :show_period, :show_outcomes, :show_description, :show_link, :item_index],
      languages_attributes: [:id, :name, :level, :show_proficiency, :item_index],
      passions_attributes: [:id, :name, :show_icon, :show_description, :item_index],
      projects_attributes: [:id, :name, :location, :duration, :description, :show_location, :show_period, :show_outcomes, :show_description, :show_link, :item_index],
      ...
      volunteers_attributes: [:id, :title, :organization_name, :duration, :description, :show_location, :show_period, :show_outcomes, :show_description, :item_index],
