class CvBuilderController < ApplicationController
  ...
  def permitted_params
    params.require(:resume).permit(:section_names,
      ...
      certificates_attributes: [:name, :institutiion_name, :id, :show_institutiion],
      courses_attributes: [:title, :description, :id, :show_description],
      strengths_attributes: [:title, :description, :id, :show_description, :show_icon],
      educations_attributes: [:degree_name, :university_name, :id, :duration, :cgpa, :show_location, :show_period, :show_outcomes, :show_gpa],
      experiences_attributes: [:id, :title, :company_name, :location, :duration, :description, :show_location, :show_period, :show_outcomes, :show_description, :show_link],
      languages_attributes: [:id, :name, :level, :show_proficiency],
      passions_attributes: [:id, :name, :show_icon, :show_description],
      projects_attributes: [:id, :name, :location, :duration, :description, :show_location, :show_period, :show_outcomes, :show_description, :show_link],
      quotes_attributes: [:id, :name, :author, :show_author],
      skills_attributes: [:id, :name, :level, :show_level],
      technologies_attributes: [:id, :name, :tec_names, :show_icon, :show_description],
      volunteers_attributes: [:id, :title, :organization_name, :duration, :description, :show_location, :show_period, :show_outcomes, :show_description],
