  ...
  render: function() {
    ...
    return (
      <div className="col-xs-12">
        <div className="page-holder bg-color page" style={{backgroundImage: "url(/assets/"+this.props.resumeStyle.background_img+")", color: this.props.resumeStyle.secondary_color}}>
