var AchievementItem = React.createClass({
  getInitialState: function(){
    ...
    return {title: achievement.title, description: achievement.description, achievement: achievement, icon: achievement.icon};
  },
  handleChange: function(e){
    ...
    itemsObj = $.grep(resume["achievements"], function (item) {
      if(item.id == subSectionId){
        item[e.target.name] = e.target.value;
      }
      return item;
    });
    resume["achievements"] = itemsObj;
  ...
  handleIcon: function(e){
    e.preventDefault();
    $(e.target).closest(".section-item").find(".acheivement-icon-holder").show();
  },

  changeIcon: function(e){
    params = {icon: $(e.target).data("iconName"), "id": $(e.target).closest(".section-item").data("achievementId")};
