var StrengthItem = React.createClass({
  ...
  getInitialState: function(){
    ...
    return {strength: strength, title: strength.title, description: strength.description, icon: strength.icon};
  },

  componentDidMount: function(){
    var _this = this;
    $(".strength-icon-holder").hide();
  },
  ...
  handleChange: function(e){
    ...
    itemsObj = $.grep(resume["strengths"], function (item) {
      if(item.id == subSectionId){
        item[e.target.name] = e.target.value;
      }
      return item;
    });
    resume["strengths"] = itemsObj;
  ...
  render: function() {
    ...
    return (
      <li className="section-item row mrl0" data-strength-id={this.props.strength.id} data-section-id={this.props.strength.id}>
