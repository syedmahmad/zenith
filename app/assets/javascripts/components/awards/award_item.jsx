var AwardItem = React.createClass({
  getInitialState: function(){
    ...
    return {name: award.name, description: award.description, icon: award.icon};
  },

  componentDidMount: function(){
    var _this = this;
    $(".award-icon-holder").hide();
  },
  ...
  changeIcon: function(e){
    params = {icon: $(e.target).data("iconName"), "id": $(e.target).closest(".section-item").data("awardId")};
    this.props.updateResume(
      {resume: {awards_attributes: params}}
    );
  ...
  handleIcon: function(e){
    e.preventDefault();
    $(e.target).closest(".section-item").find(".award-icon-holder").show();
  },
      ...
      <li className="section-item row mrl0" data-award-id={this.props.award.id} data-section-id={this.props.award.id}>
        ...
        { this.props.award.show_icon &&
          <div className="icon-holder pull-left"> 
           ...
           <section className="award-icon-holder">
            {
