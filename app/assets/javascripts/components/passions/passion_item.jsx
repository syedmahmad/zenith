var PassionItem = React.createClass({
  ...
  getInitialState: function(){
    ...
    return {passion: passion, name: passion.name, description: passion.description, icon: passion.icon};
  },

  componentDidMount: function(){
    var _this = this;
    $(".passion-icon-holder").hide();
  },
  ...
  changeIcon: function(e){
    params = {icon: $(e.target).data("iconName"), "id": $(e.target).closest(".section-item").data("passionId")};
    this.props.updateResume(
      {resume: {passions_attributes: params}}
    );
  ...
  handleIcon: function(e){
    e.preventDefault();
    $(e.target).closest(".section-item").find(".passion-icon-holder").show();
  },
